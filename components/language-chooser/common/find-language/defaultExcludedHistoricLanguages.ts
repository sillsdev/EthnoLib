...
let defaultExcludedHistoricLanguageCodes: Set<string> | null = null;

export function getDefaultExcludedHistoricLanguageCodes(): Set<string> {
  if (!defaultExcludedHistoricLanguageCodes) {
    defaultExcludedHistoricLanguageCodes = new Set([
  ...
  return defaultExcludedHistoricLanguageCodes;
}
