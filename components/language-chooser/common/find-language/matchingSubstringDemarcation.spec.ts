...
describe("demarcating only the best result for different situations", () => {
  ...
  it("prioritizes demarcating whole word matches, then start-of-word matches, then substring matches", () => {
    const searchString = "papaya";
    const startOfWordMatch = "papayafruit";
    ...
    result.exonym = startOfWordMatch;
    expectOnlySpecifiedDemarcation(
      "exonym",
      searchString,
      demarcateResults([result], searchString)[0]
