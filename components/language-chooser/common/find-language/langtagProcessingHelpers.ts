...
export const scriptNames = iso15924.reduce(
...
export const isoCodesDetails = {} as any;
export const iso639_1To639_3 = {} as any;
...
export const indivlangsToMacrolangs = {} as any;
...
export const macrolangsToRepresentativeLangs = {} as any;
...
export function languageType(iso639_3: string) {
...
export function findIndivIsoCode(macrolangCodeEntry: any) {
...
export function findPotentialIso639Code(
  languageTag: string
): string | undefined {
...
export function getAllPossibleNames(entry: any) {
  return new Set([
    ...(entry.names || []),
    entry.localname,
    entry.name,
